        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisciplineGoal = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DisciplineObjectives = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MainSections = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TeacherImageId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Teachers_TeacherImages_TeacherImageId",
                        column: x => x.TeacherImageId,
                        principalTable: "TeacherImages",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Teachers_TeacherImageId",
                table: "Teachers",
                column: "TeacherImageId");
        }
